...
public ModelLogin imprimirRelatorio(Long id) throws Exception {
		...
		String sql = "SELECT colaboradores.*, avaliacao.data, avaliacao.mediavaliacao, avaliacao.mediavaliacao2, avaliacao.mediavaliacao3, avaliacao.mediavaliacao4, avaliacao.mediavaliacao5, avaliacao.mediavaliacao6, avaliacao.mediavaliacao7, avaliacao.mediavaliacao8 FROM colaboradores LEFT JOIN avaliacao ON colaboradores.id = avaliacao.colaboradores_pai_id WHERE colaboradores.id = ?;";
		PreparedStatement statement = connection.prepareStatement(sql);
		statement.setLong(1, id);
