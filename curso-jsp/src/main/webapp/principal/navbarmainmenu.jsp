                         ...
                         <!--  <div class="pcoded-navigation-label" data-i18n="nav.category.navigation">Layout</div> -->
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <c:if test="${perfil == 'ADMIN' || perfil == 'TI'}"> 
                                      <li class=" ">
                                          <a href="<%= request.getContextPath() %>/ServletUsuarioContoller?acao=ListarUser" class="waves-effect waves-dark">
                          ...
                          <div class="pcoded-navigation-label" data-i18n="nav.category.forms">Formulário</div>
                          <ul class="pcoded-item pcoded-left-item">
                              <li>
                                  <a href="<%= request.getContextPath() %>/principal/avaliacao.jsp" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main">Avaliação</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>
                              <!-- 
